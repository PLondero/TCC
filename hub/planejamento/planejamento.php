    ...
    <body>
        <div class="container">
            ...
            <section class="dashboard">
                <h1 class="titulo"> Planejamento Financeiro</h1>
                <div class="partecima">
                ...
                <section class="boxs">
                    <div class="back">
                      <div class="linha-baixo">
                          ...
                          <button id="openModalBtn"> + Criar Nova Meta</button>
                      </div>
                    </div>

                    <div id="modal" class="modal" aria-hidden="true">
                      <div class="modal-content">
                        <span id="closeModalBtn" class="fechar">&times;</span>
                        <h2>Criar Nova Meta</h2>

                        <form id="formNovaMeta" method="post" action="handler.php">
                          <label for="nomeMeta">Nome da meta</label>
                          <input id="nomeMeta" type="text" placeholder="Ex: Viagem para praia" required name="meta">

                          <label for="valorObjetivo">Valor objetivo (R$)</label>
                          <input id="valorObjetivo" type="number" placeholder="1500" min="0" step="0.01" required name="valor_total">

                          <label for="valorAtual">Valor atual (R$)</label>
                          <input id="valorAtual" type="number" placeholder="600" min="0" step="0.01" value="0" required name="valor_atual">
